!(function (t) {
    ...
    ;(o.prototype = new n.L2DBaseModel()),
      (o.prototype.load = function (t, i, e) {
        ...
        this.modelSetting.loadModelSetting(i, function () {
          var t = new URL(
            `../model/${r.modelSetting.getModelName()}/${r.modelSetting.getModelFile()}`,
            import.meta.url
          ).href
          ...
          r.loadModelData(t, function (t) {
            for (var i = 0; i < r.modelSetting.getTextureNum(); i++) {
              if (/^https?:\/\/|^\/\//i.test(r.modelSetting.getTextureFile(i)))
                ...
                var o = new URL(
                  `../model/${r.modelSetting.getModelName(i)}/${r.modelSetting.getTextureFile(i)}`,
                  import.meta.url
                ).href
  ...
  function (t, i, e) {
    ...
    ;(r.prototype.loadModelSetting = function (t, i) {
      ...
      (r.prototype.getModelName = function () {
        return this.json[this.MODEL_NAME]
      }),
